// Migrated from cheating-daddy/src/utils/prompts.js
...
export const profilePrompts: Record<string, PromptParts> = {
  interview: {
...
export function buildSystemPrompt(promptParts: PromptParts, customPrompt: string = '', googleSearchEnabled: boolean = true): string {
...
export function getSystemPrompt(profile: string, customPrompt: string = '', googleSearchEnabled: boolean = true): string {
